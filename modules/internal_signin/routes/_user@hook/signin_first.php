...
<div class="notification" style="background:#63666a;">
    ...
    <p>
        If you have access to your main campus NetID account because you are still enrolled or are now staff or faculty, <a href="<?php echo $url_netid; ?>">sign in with it here</a>.
    </p>
    <p>
...
<div class="digraph-card incidental" style="background:rgba(237, 139, 0, 0.25);">
    ...
    <p>
        ...
        This account should be created with an email address that you currently have access to, and it will have its own password separate from your NetID, and it will only work on this site.
    </p>
    <ul>
